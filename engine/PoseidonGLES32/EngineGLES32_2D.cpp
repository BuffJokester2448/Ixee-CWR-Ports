...
void EngineGLES32::Draw2D(const Draw2DPars& pars, const Rect2DAbs& rect, const Rect2DAbs& clip)
{
...
void EngineGLES32::DrawLine(const Line2DAbs& line, PackedColor c0, PackedColor c1, const Rect2DAbs& clip)
{
    float x0 = line.beg.x;
    float y0 = line.beg.y;
    float x1 = line.end.x;
...
void EngineGLES32::DrawPoly(const MipInfo& mip, const Vertex2DPixel* vertices, int n, const Rect2DPixel& clipRect,
                          int specFlags)
{
    if (_resetNeeded)
    {
...
void EngineGLES32::DrawPoly(const MipInfo& mip, const Vertex2DAbs* vertices, int n, const Rect2DAbs& clipRect,
                          int specFlags)
{
    if (_resetNeeded)
    {
...
void EngineGLES32::DrawLine(int beg, int end)
{
